...
fn test_scan_finds_mappings() {
    ...
    assert_eq!(stats.kea_subnets_found, 1, "Should find 1 Kea subnet");
    assert_eq!(
...
fn test_scan_finds_v6_mappings() {
    ...
    assert_eq!(stats.kea_subnets_found, 0);
    assert_eq!(stats.kea_subnets_v6_found, 1);
